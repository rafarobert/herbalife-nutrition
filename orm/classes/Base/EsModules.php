...
/**
 * Base class that represents a row from the 'es_modules' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class EsModules implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EsModulesTableMap';
    ...
    /**
     * Initializes internal state of Base\EsModules object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>EsModules</code> instance.  If
     * <code>obj</code> is an instance of <code>EsModules</code>, delegates to
     * <code>equals(EsModules)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EsModules The current object, for fluid interface
     */
     ...
     * @return $this|\EsModules The current object (for fluent API support)
     */
    public function setIdModule($v)
    {
        ...
        if ($this->id_module !== $v) {
            $this->id_module = $v;
            $this->modifiedColumns[EsModulesTableMap::COL_ID_MODULE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[EsModulesTableMap::COL_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[EsModulesTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[EsModulesTableMap::COL_STATUS] = true;
        }
    ...
    public function setChangeCount($v)
    {
        ...
        if ($this->change_count !== $v) {
            $this->change_count = $v;
            $this->modifiedColumns[EsModulesTableMap::COL_CHANGE_COUNT] = true;
        }
    ...
    public function setIdUserModified($v)
    {
        ...
        if ($this->id_user_modified !== $v) {
            ...
            $this->modifiedColumns[EsModulesTableMap::COL_ID_USER_MODIFIED] = true;
        }
    ...
    public function setIdUserCreated($v)
    {
        ...
        if ($this->id_user_created !== $v) {
            ...
            $this->modifiedColumns[EsModulesTableMap::COL_ID_USER_CREATED] = true;
        }
    ...
    public function setDateModified($v)
    {
        ...
        if ($this->date_modified !== null || $dt !== null) {
            if ($this->date_modified === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_modified->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EsModulesTableMap::COL_DATE_MODIFIED] = true;
            }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($this->date_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EsModulesTableMap::COL_DATE_CREATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EsModulesTableMap::translateFieldName('IdModule', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_module = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EsModulesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EsModulesTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EsModulesTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EsModulesTableMap::translateFieldName('ChangeCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_count = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EsModulesTableMap::translateFieldName('IdUserModified', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_modified = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EsModulesTableMap::translateFieldName('IdUserCreated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_created = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EsModulesTableMap::translateFieldName('DateModified', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_modified = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : EsModulesTableMap::translateFieldName('DateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = EsModulesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EsModules'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEsModulesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EsModules::setDeleted()
     * @see EsModules::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEsModulesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EsModulesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EsModulesTableMap::COL_ID_MODULE)) {
            $modifiedColumns[':p' . $index++]  = 'id_module';
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_CHANGE_COUNT)) {
            $modifiedColumns[':p' . $index++]  = 'change_count';
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_ID_USER_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_modified';
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_ID_USER_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_created';
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_DATE_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'date_modified';
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_DATE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_created';
        }

        $sql = sprintf(
            'INSERT INTO es_modules (%s) VALUES (%s)',
    ...
    {
        $pos = EsModulesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['EsModules'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EsModules'][$this->hashCode()] = true;
        $keys = EsModulesTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EsModulesTableMap::COL_ID_MODULE)) {
            $criteria->add(EsModulesTableMap::COL_ID_MODULE, $this->id_module);
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_NAME)) {
            $criteria->add(EsModulesTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_DESCRIPTION)) {
            $criteria->add(EsModulesTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_STATUS)) {
            $criteria->add(EsModulesTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_CHANGE_COUNT)) {
            $criteria->add(EsModulesTableMap::COL_CHANGE_COUNT, $this->change_count);
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_ID_USER_MODIFIED)) {
            $criteria->add(EsModulesTableMap::COL_ID_USER_MODIFIED, $this->id_user_modified);
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_ID_USER_CREATED)) {
            $criteria->add(EsModulesTableMap::COL_ID_USER_CREATED, $this->id_user_created);
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_DATE_MODIFIED)) {
            $criteria->add(EsModulesTableMap::COL_DATE_MODIFIED, $this->date_modified);
        }
        if ($this->isColumnModified(EsModulesTableMap::COL_DATE_CREATED)) {
            $criteria->add(EsModulesTableMap::COL_DATE_CREATED, $this->date_created);
        }
    ...
    {
        $criteria = ChildEsModulesQuery::create();
        $criteria->add(EsModulesTableMap::COL_ID_MODULE, $this->id_module);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EsModules (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EsModules Clone of current object.
     * @throws PropelException
     */
    ...
    public function setEsUsersRelatedByIdUserModified(ChildEsUsers $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEsModulesRelatedByIdUserModified($this);
        }
    ...
    public function getEsUsersRelatedByIdUserModified(ConnectionInterface $con = null)
    {
        if ($this->aEsUsersRelatedByIdUserModified === null && ($this->id_user_modified != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEsUsersRelatedByIdUserModified->addEsModulessRelatedByIdUserModified($this);
             */
        }
    ...
    public function setEsUsersRelatedByIdUserCreated(ChildEsUsers $v = null)
    {
        ...
        // If this object has already been added to the ChildEsUsers object, it will not be re-added.
        if ($v !== null) {
            $v->addEsModulesRelatedByIdUserCreated($this);
        }
    ...
    public function getEsUsersRelatedByIdUserCreated(ConnectionInterface $con = null)
    {
        if ($this->aEsUsersRelatedByIdUserCreated === null && ($this->id_user_created != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEsUsersRelatedByIdUserCreated->addEsModulessRelatedByIdUserCreated($this);
             */
        }
     ...
     * If this ChildEsModules is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildEsModules The current object (for fluent API support)
     */
    public function setEsTabless(Collection $esTabless, ConnectionInterface $con = null)
    {
        ...
        foreach ($esTablessToDelete as $esTablesRemoved) {
            $esTablesRemoved->setEsModules(null);
        }
     ...
     * Otherwise if this EsModules is new, it will return
     * an empty collection; or if this EsModules has previously
     * been saved, it will retrieve related EsTabless from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EsModules.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildEsTables[] List of ChildEsTables objects
     */
    public function getEsTablessJoinEsRoles(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildEsTablesQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aEsUsersRelatedByIdUserModified) {
            $this->aEsUsersRelatedByIdUserModified->removeEsModulesRelatedByIdUserModified($this);
        }
        if (null !== $this->aEsUsersRelatedByIdUserCreated) {
            $this->aEsUsersRelatedByIdUserCreated->removeEsModulesRelatedByIdUserCreated($this);
        }
        $this->id_module = null;
        $this->name = null;
    ...
    {
        return (string) $this->exportTo(EsModulesTableMap::DEFAULT_STRING_FORMAT);
    }

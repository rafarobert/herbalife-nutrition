...
/**
 * Base class that represents a row from the 'es_users_roles' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class EsUsersRoles implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EsUsersRolesTableMap';
    ...
    /**
     * The value for the id_user_role field.
     *
     * @var        int
     */
     ...
     * @var        ChildEsUsers
     */
    protected $aEsUsersRelatedByIdUser;
    ...
    /**
     * Initializes internal state of Base\EsUsersRoles object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>EsUsersRoles</code> instance.  If
     * <code>obj</code> is an instance of <code>EsUsersRoles</code>, delegates to
     * <code>equals(EsUsersRoles)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EsUsersRoles The current object, for fluid interface
     */
    ...
    /**
     * Get the [id_user_role] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [id_user_role] column.
     *
     * @param int $v new value
     * @return $this|\EsUsersRoles The current object (for fluent API support)
     */
    public function setIdUserRole($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_user_role !== $v) {
            $this->id_user_role = $v;
            $this->modifiedColumns[EsUsersRolesTableMap::COL_ID_USER_ROLE] = true;
        }
    ...
    public function setIdUser($v)
    {
        ...
        if ($this->id_user !== $v) {
            $this->id_user = $v;
            $this->modifiedColumns[EsUsersRolesTableMap::COL_ID_USER] = true;
        }

        if ($this->aEsUsersRelatedByIdUser !== null && $this->aEsUsersRelatedByIdUser->getIdUser() !== $v) {
            $this->aEsUsersRelatedByIdUser = null;
        }
    ...
    public function setIdRole($v)
    {
        ...
        if ($this->id_role !== $v) {
            $this->id_role = $v;
            $this->modifiedColumns[EsUsersRolesTableMap::COL_ID_ROLE] = true;
        }
    ...
    public function setEstado($v)
    {
        ...
        if ($this->estado !== $v) {
            $this->estado = $v;
            $this->modifiedColumns[EsUsersRolesTableMap::COL_ESTADO] = true;
        }
    ...
    public function setChangeCount($v)
    {
        ...
        if ($this->change_count !== $v) {
            $this->change_count = $v;
            $this->modifiedColumns[EsUsersRolesTableMap::COL_CHANGE_COUNT] = true;
        }
    ...
    public function setIdUserModified($v)
    {
        ...
        if ($this->id_user_modified !== $v) {
            ...
            $this->modifiedColumns[EsUsersRolesTableMap::COL_ID_USER_MODIFIED] = true;
        }
    ...
    public function setIdUserCreated($v)
    {
        ...
        if ($this->id_user_created !== $v) {
            ...
            $this->modifiedColumns[EsUsersRolesTableMap::COL_ID_USER_CREATED] = true;
        }
    ...
    public function setDateModified($v)
    {
        ...
        if ($this->date_modified !== null || $dt !== null) {
            if ($this->date_modified === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_modified->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EsUsersRolesTableMap::COL_DATE_MODIFIED] = true;
            }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($this->date_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EsUsersRolesTableMap::COL_DATE_CREATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EsUsersRolesTableMap::translateFieldName('IdUserRole', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_role = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EsUsersRolesTableMap::translateFieldName('IdUser', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EsUsersRolesTableMap::translateFieldName('IdRole', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_role = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EsUsersRolesTableMap::translateFieldName('Estado', TableMap::TYPE_PHPNAME, $indexType)];
            $this->estado = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EsUsersRolesTableMap::translateFieldName('ChangeCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_count = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EsUsersRolesTableMap::translateFieldName('IdUserModified', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_modified = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EsUsersRolesTableMap::translateFieldName('IdUserCreated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_created = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EsUsersRolesTableMap::translateFieldName('DateModified', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_modified = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : EsUsersRolesTableMap::translateFieldName('DateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = EsUsersRolesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EsUsersRoles'), 0, $e);
        }
    }
    ...
    {
        if ($this->aEsUsersRelatedByIdUser !== null && $this->id_user !== $this->aEsUsersRelatedByIdUser->getIdUser()) {
            $this->aEsUsersRelatedByIdUser = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEsUsersRolesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EsUsersRoles::setDeleted()
     * @see EsUsersRoles::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEsUsersRolesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EsUsersRolesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aEsUsersRelatedByIdUser !== null) {
                if ($this->aEsUsersRelatedByIdUser->isModified() || $this->aEsUsersRelatedByIdUser->isNew()) {
                    $affectedRows += $this->aEsUsersRelatedByIdUser->save($con);
                }
                $this->setEsUsersRelatedByIdUser($this->aEsUsersRelatedByIdUser);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_USER_ROLE)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_role';
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_USER)) {
            $modifiedColumns[':p' . $index++]  = 'id_user';
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_ROLE)) {
            $modifiedColumns[':p' . $index++]  = 'id_role';
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ESTADO)) {
            $modifiedColumns[':p' . $index++]  = 'estado';
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_CHANGE_COUNT)) {
            $modifiedColumns[':p' . $index++]  = 'change_count';
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_USER_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_modified';
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_USER_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_created';
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_DATE_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'date_modified';
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_DATE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_created';
        }

        $sql = sprintf(
            'INSERT INTO es_users_roles (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_user_role':
                        $stmt->bindValue($identifier, $this->id_user_role, PDO::PARAM_INT);
                        break;
                    case 'id_user':
    ...
    {
        $pos = EsUsersRolesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['EsUsersRoles'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EsUsersRoles'][$this->hashCode()] = true;
        $keys = EsUsersRolesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdUserRole(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aEsUsersRelatedByIdUser) {
                ...
                $result[$key] = $this->aEsUsersRelatedByIdUser->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_USER_ROLE)) {
            $criteria->add(EsUsersRolesTableMap::COL_ID_USER_ROLE, $this->id_user_role);
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_USER)) {
            $criteria->add(EsUsersRolesTableMap::COL_ID_USER, $this->id_user);
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_ROLE)) {
            $criteria->add(EsUsersRolesTableMap::COL_ID_ROLE, $this->id_role);
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ESTADO)) {
            $criteria->add(EsUsersRolesTableMap::COL_ESTADO, $this->estado);
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_CHANGE_COUNT)) {
            $criteria->add(EsUsersRolesTableMap::COL_CHANGE_COUNT, $this->change_count);
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_USER_MODIFIED)) {
            $criteria->add(EsUsersRolesTableMap::COL_ID_USER_MODIFIED, $this->id_user_modified);
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_ID_USER_CREATED)) {
            $criteria->add(EsUsersRolesTableMap::COL_ID_USER_CREATED, $this->id_user_created);
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_DATE_MODIFIED)) {
            $criteria->add(EsUsersRolesTableMap::COL_DATE_MODIFIED, $this->date_modified);
        }
        if ($this->isColumnModified(EsUsersRolesTableMap::COL_DATE_CREATED)) {
            $criteria->add(EsUsersRolesTableMap::COL_DATE_CREATED, $this->date_created);
        }
    ...
    {
        $criteria = ChildEsUsersRolesQuery::create();
        $criteria->add(EsUsersRolesTableMap::COL_ID_USER_ROLE, $this->id_user_role);
    ...
    {
        $validPk = null !== $this->getIdUserRole();
    ...
    /**
     * Generic method to set the primary key (id_user_role column).
     *
    ...
    {
        return null === $this->getIdUserRole();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EsUsersRoles (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdUserRole(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EsUsersRoles Clone of current object.
     * @throws PropelException
     */
    ...
    public function setEsUsersRelatedByIdUserCreated(ChildEsUsers $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEsUsersRolesRelatedByIdUserCreated($this);
        }
    ...
    public function getEsUsersRelatedByIdUserCreated(ConnectionInterface $con = null)
    {
        if ($this->aEsUsersRelatedByIdUserCreated === null && ($this->id_user_created != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEsUsersRelatedByIdUserCreated->addEsUsersRolessRelatedByIdUserCreated($this);
             */
        }
    ...
    public function setEsUsersRelatedByIdUserModified(ChildEsUsers $v = null)
    {
        ...
        // If this object has already been added to the ChildEsUsers object, it will not be re-added.
        if ($v !== null) {
            $v->addEsUsersRolesRelatedByIdUserModified($this);
        }
    ...
    public function getEsUsersRelatedByIdUserModified(ConnectionInterface $con = null)
    {
        if ($this->aEsUsersRelatedByIdUserModified === null && ($this->id_user_modified != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEsUsersRelatedByIdUserModified->addEsUsersRolessRelatedByIdUserModified($this);
             */
        }
     ...
     * @throws PropelException
     */
    public function setEsUsersRelatedByIdUser(ChildEsUsers $v = null)
    {
        if ($v === null) {
            $this->setIdUser(NULL);
        } else {
        ...
        $this->aEsUsersRelatedByIdUser = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildEsUsers object, it will not be re-added.
        if ($v !== null) {
            $v->addEsUsersRolesRelatedByIdUser($this);
        }
     ...
     * @throws PropelException
     */
    public function getEsUsersRelatedByIdUser(ConnectionInterface $con = null)
    {
        if ($this->aEsUsersRelatedByIdUser === null && ($this->id_user != 0)) {
            $this->aEsUsersRelatedByIdUser = ChildEsUsersQuery::create()->findPk($this->id_user, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEsUsersRelatedByIdUser->addEsUsersRolessRelatedByIdUser($this);
             */
        }

        return $this->aEsUsersRelatedByIdUser;
    }
    ...
    public function getEsRoles(ConnectionInterface $con = null)
    {
        if ($this->aEsRoles === null && ($this->id_role != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEsRoles->addEsUsersRoless($this);
             */
        }
    ...
    {
        if (null !== $this->aEsUsersRelatedByIdUserCreated) {
            $this->aEsUsersRelatedByIdUserCreated->removeEsUsersRolesRelatedByIdUserCreated($this);
        }
        if (null !== $this->aEsUsersRelatedByIdUserModified) {
            $this->aEsUsersRelatedByIdUserModified->removeEsUsersRolesRelatedByIdUserModified($this);
        }
        if (null !== $this->aEsUsersRelatedByIdUser) {
            $this->aEsUsersRelatedByIdUser->removeEsUsersRolesRelatedByIdUser($this);
        }
        if (null !== $this->aEsRoles) {
            $this->aEsRoles->removeEsUsersRoles($this);
        }
        $this->id_user_role = null;
        $this->id_user = null;
        $this->id_role = null;
        $this->estado = null;
    ...
    {
        return (string) $this->exportTo(EsUsersRolesTableMap::DEFAULT_STRING_FORMAT);
    }

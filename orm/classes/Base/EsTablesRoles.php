...
/**
 * Base class that represents a row from the 'es_tables_roles' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class EsTablesRoles implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EsTablesRolesTableMap';
    ...
    /**
     * The value for the id_table_role field.
     *
     * @var        int
     */
    protected $id_table_role;
    ...
    /**
     * Initializes internal state of Base\EsTablesRoles object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>EsTablesRoles</code> instance.  If
     * <code>obj</code> is an instance of <code>EsTablesRoles</code>, delegates to
     * <code>equals(EsTablesRoles)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|EsTablesRoles The current object, for fluid interface
     */
    ...
    /**
     * Get the [id_table_role] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [id_table_role] column.
     *
     * @param int $v new value
     * @return $this|\EsTablesRoles The current object (for fluent API support)
     */
    public function setIdTableRole($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->id_table_role !== $v) {
            $this->id_table_role = $v;
            $this->modifiedColumns[EsTablesRolesTableMap::COL_ID_TABLE_ROLE] = true;
        }
    ...
    public function setIdTable($v)
    {
        ...
        if ($this->id_table !== $v) {
            $this->id_table = $v;
            $this->modifiedColumns[EsTablesRolesTableMap::COL_ID_TABLE] = true;
        }

        if ($this->aEsTables !== null && $this->aEsTables->getIdTable() !== $v) {
            $this->aEsTables = null;
        }
    ...
    public function setIdRole($v)
    {
        ...
        if ($this->id_role !== $v) {
            $this->id_role = $v;
            $this->modifiedColumns[EsTablesRolesTableMap::COL_ID_ROLE] = true;
        }
    ...
    public function setEstado($v)
    {
        ...
        if ($this->estado !== $v) {
            $this->estado = $v;
            $this->modifiedColumns[EsTablesRolesTableMap::COL_ESTADO] = true;
        }
    ...
    public function setChangeCount($v)
    {
        ...
        if ($this->change_count !== $v) {
            $this->change_count = $v;
            $this->modifiedColumns[EsTablesRolesTableMap::COL_CHANGE_COUNT] = true;
        }
    ...
    public function setIdUserModified($v)
    {
        ...
        if ($this->id_user_modified !== $v) {
            ...
            $this->modifiedColumns[EsTablesRolesTableMap::COL_ID_USER_MODIFIED] = true;
        }
    ...
    public function setIdUserCreated($v)
    {
        ...
        if ($this->id_user_created !== $v) {
            ...
            $this->modifiedColumns[EsTablesRolesTableMap::COL_ID_USER_CREATED] = true;
        }
    ...
    public function setDateModified($v)
    {
        ...
        if ($this->date_modified !== null || $dt !== null) {
            if ($this->date_modified === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_modified->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EsTablesRolesTableMap::COL_DATE_MODIFIED] = true;
            }
    ...
    public function setDateCreated($v)
    {
        ...
        if ($this->date_created !== null || $dt !== null) {
            if ($this->date_created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->date_created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[EsTablesRolesTableMap::COL_DATE_CREATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : EsTablesRolesTableMap::translateFieldName('IdTableRole', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_table_role = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EsTablesRolesTableMap::translateFieldName('IdTable', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_table = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EsTablesRolesTableMap::translateFieldName('IdRole', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_role = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EsTablesRolesTableMap::translateFieldName('Estado', TableMap::TYPE_PHPNAME, $indexType)];
            $this->estado = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EsTablesRolesTableMap::translateFieldName('ChangeCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_count = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EsTablesRolesTableMap::translateFieldName('IdUserModified', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_modified = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : EsTablesRolesTableMap::translateFieldName('IdUserCreated', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id_user_created = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : EsTablesRolesTableMap::translateFieldName('DateModified', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date_modified = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : EsTablesRolesTableMap::translateFieldName('DateCreated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = EsTablesRolesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\EsTablesRoles'), 0, $e);
        }
    }
    ...
    {
        if ($this->aEsTables !== null && $this->id_table !== $this->aEsTables->getIdTable()) {
            $this->aEsTables = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEsTablesRolesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see EsTablesRoles::setDeleted()
     * @see EsTablesRoles::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEsTablesRolesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EsTablesRolesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aEsTables !== null) {
                if ($this->aEsTables->isModified() || $this->aEsTables->isNew()) {
                    $affectedRows += $this->aEsTables->save($con);
                }
                $this->setEsTables($this->aEsTables);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_TABLE_ROLE)) {
            $modifiedColumns[':p' . $index++]  = 'id_table_role';
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_TABLE)) {
            $modifiedColumns[':p' . $index++]  = 'id_table';
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_ROLE)) {
            $modifiedColumns[':p' . $index++]  = 'id_role';
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ESTADO)) {
            $modifiedColumns[':p' . $index++]  = 'estado';
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_CHANGE_COUNT)) {
            $modifiedColumns[':p' . $index++]  = 'change_count';
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_USER_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_modified';
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_USER_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'id_user_created';
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_DATE_MODIFIED)) {
            $modifiedColumns[':p' . $index++]  = 'date_modified';
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_DATE_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'date_created';
        }

        $sql = sprintf(
            'INSERT INTO es_tables_roles (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id_table_role':
                        $stmt->bindValue($identifier, $this->id_table_role, PDO::PARAM_INT);
                        break;
                    case 'id_table':
    ...
    {
        $pos = EsTablesRolesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['EsTablesRoles'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EsTablesRoles'][$this->hashCode()] = true;
        $keys = EsTablesRolesTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdTableRole(),
            $keys[1] => $this->getIdTable(),
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aEsTables) {
                ...
                $result[$key] = $this->aEsTables->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIdTableRole($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setIdTable($arr[$keys[1]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_TABLE_ROLE)) {
            $criteria->add(EsTablesRolesTableMap::COL_ID_TABLE_ROLE, $this->id_table_role);
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_TABLE)) {
            $criteria->add(EsTablesRolesTableMap::COL_ID_TABLE, $this->id_table);
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_ROLE)) {
            $criteria->add(EsTablesRolesTableMap::COL_ID_ROLE, $this->id_role);
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ESTADO)) {
            $criteria->add(EsTablesRolesTableMap::COL_ESTADO, $this->estado);
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_CHANGE_COUNT)) {
            $criteria->add(EsTablesRolesTableMap::COL_CHANGE_COUNT, $this->change_count);
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_USER_MODIFIED)) {
            $criteria->add(EsTablesRolesTableMap::COL_ID_USER_MODIFIED, $this->id_user_modified);
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_ID_USER_CREATED)) {
            $criteria->add(EsTablesRolesTableMap::COL_ID_USER_CREATED, $this->id_user_created);
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_DATE_MODIFIED)) {
            $criteria->add(EsTablesRolesTableMap::COL_DATE_MODIFIED, $this->date_modified);
        }
        if ($this->isColumnModified(EsTablesRolesTableMap::COL_DATE_CREATED)) {
            $criteria->add(EsTablesRolesTableMap::COL_DATE_CREATED, $this->date_created);
        }
    ...
    {
        $criteria = ChildEsTablesRolesQuery::create();
        $criteria->add(EsTablesRolesTableMap::COL_ID_TABLE_ROLE, $this->id_table_role);
    ...
    {
        $validPk = null !== $this->getIdTableRole();
    ...
    /**
     * Generic method to set the primary key (id_table_role column).
     *
    ...
    {
        return null === $this->getIdTableRole();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EsTablesRoles (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdTableRole(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EsTablesRoles Clone of current object.
     * @throws PropelException
     */
    ...
    public function setEsUsersRelatedByIdUserCreated(ChildEsUsers $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEsTablesRolesRelatedByIdUserCreated($this);
        }
    ...
    public function getEsUsersRelatedByIdUserCreated(ConnectionInterface $con = null)
    {
        if ($this->aEsUsersRelatedByIdUserCreated === null && ($this->id_user_created != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEsUsersRelatedByIdUserCreated->addEsTablesRolessRelatedByIdUserCreated($this);
             */
        }
    ...
    public function setEsUsersRelatedByIdUserModified(ChildEsUsers $v = null)
    {
        ...
        // If this object has already been added to the ChildEsUsers object, it will not be re-added.
        if ($v !== null) {
            $v->addEsTablesRolesRelatedByIdUserModified($this);
        }
    ...
    public function getEsUsersRelatedByIdUserModified(ConnectionInterface $con = null)
    {
        if ($this->aEsUsersRelatedByIdUserModified === null && ($this->id_user_modified != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEsUsersRelatedByIdUserModified->addEsTablesRolessRelatedByIdUserModified($this);
             */
        }
    ...
    /**
     * Declares an association between this object and a ChildEsTables object.
     *
     * @param  ChildEsTables $v
     * @return $this|\EsTablesRoles The current object (for fluent API support)
     * @throws PropelException
     */
    public function setEsTables(ChildEsTables $v = null)
    {
        if ($v === null) {
            $this->setIdTable(NULL);
        } else {
            $this->setIdTable($v->getIdTable());
        }

        $this->aEsTables = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildEsTables object, it will not be re-added.
        if ($v !== null) {
            $v->addEsTablesRoles($this);
        }
    ...
    /**
     * Get the associated ChildEsTables object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildEsTables The associated ChildEsTables object.
     * @throws PropelException
     */
    public function getEsTables(ConnectionInterface $con = null)
    {
        if ($this->aEsTables === null && ($this->id_table != 0)) {
            $this->aEsTables = ChildEsTablesQuery::create()->findPk($this->id_table, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEsTables->addEsTablesRoless($this);
             */
        }

        return $this->aEsTables;
    }
    ...
    public function getEsRoles(ConnectionInterface $con = null)
    {
        if ($this->aEsRoles === null && ($this->id_role != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEsRoles->addEsTablesRoless($this);
             */
        }
    ...
    {
        if (null !== $this->aEsUsersRelatedByIdUserCreated) {
            $this->aEsUsersRelatedByIdUserCreated->removeEsTablesRolesRelatedByIdUserCreated($this);
        }
        if (null !== $this->aEsUsersRelatedByIdUserModified) {
            $this->aEsUsersRelatedByIdUserModified->removeEsTablesRolesRelatedByIdUserModified($this);
        }
        if (null !== $this->aEsTables) {
            $this->aEsTables->removeEsTablesRoles($this);
        }
        if (null !== $this->aEsRoles) {
            $this->aEsRoles->removeEsTablesRoles($this);
        }
        $this->id_table_role = null;
        $this->id_table = null;
        $this->id_role = null;
        $this->estado = null;
    ...
    {
        return (string) $this->exportTo(EsTablesRolesTableMap::DEFAULT_STRING_FORMAT);
    }
